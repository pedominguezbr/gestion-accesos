<%@ Page Title="" Language="C#" MasterPageFile="~/SgaGestionAcceso.Master" AutoEventWireup="true" CodeBehind="frmAgenteValidadorSeguim.aspx.cs" Inherits="SgaGestionAcceso.WEB.GenAgenteValidador.frmAgenteValidadorSeguim" %>
...
<asp:UpdatePanel ID="upGrilla" runat="server">
        <ContentTemplate>
            <div>
                <div class="panel">
                    <h1 class="rounded">
                        Seguimiento de Generación de Validador</h1>
