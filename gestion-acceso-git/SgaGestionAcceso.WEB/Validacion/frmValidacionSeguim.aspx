<%@ Page Title="" Language="C#" MasterPageFile="~/SgaGestionAcceso.Master" AutoEventWireup="true" CodeBehind="frmValidacionSeguim.aspx.cs" Inherits="SgaGestionAcceso.WEB.Validacion.frmValidacionSeguim" %>
...
<asp:UpdatePanel ID="upGrilla" runat="server">
        <ContentTemplate>
            <div>
                <div class="panel">
                    <h1 class="rounded">
                        Seguimiento de Validación de Solicitud de Acceso</h1>
