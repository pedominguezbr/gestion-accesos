...
{
    public partial class frmValidacionSeguim : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    ddlEstado.SelectedIndex = BLValidacionEndPoint.TraeCodEstado("EN PROCESO");
                    BuscarSolicitudes();
                }
            }
            catch (Exception ex)
        ...
        protected void dgvSolicitudAcceso_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            {
                Response.Redirect(String.Format("~/Validacion/frmValidacionSolicitud.aspx?modo=CONSULTAR&IdSolicitudAcceso={0}", idSolicitud));
            }
        }
