<%@ Page Title="" Language="C#" MasterPageFile="~/SgaGestionAcceso.Master" AutoEventWireup="true"
    CodeBehind="frmSolicitudAccesoSeguim.aspx.cs" Inherits="SgaGestionAcceso.WEB.Solicitud.frmSolicitudAccesoSeguim" %>
        ...
        <ContentTemplate>
            <div>
                <div class="panel">
                    ...
                    <h1 class="rounded">
                        <label>Seguimiento de Solicitud de Acceso</label></h1>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" class="fix rounded size700">
                        <tbody>
                            ...
                            <tr>
                                <td colspan="3">
                                    <asp:Button ID="btnNuevaSolicitud" runat="server" Text="Nueva Solicitud" CssClass="btn rounded btn_add fleft"
                                        ValidationGroup="validacion" OnClick="btnNuevaSolicitud_Click" />
                                </td>
                                <td>
                                    &nbsp;
                                </td>
                ...
                <div>
                    ...
                    <asp:GridView ID="dgvSolicitudAcceso" runat="server" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkModificar" runat="server" CommandArgument='<%# Eval("IdSolicitud") %>'
                                        CommandName="cmdModificar" CssClass="modificar" ToolTip="Editar Solicitud">
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:LinkButton ID="lnkAnular" runat="server" CommandArgument='<%# Eval("IdSolicitud") %>'
                                        CommandName="cmdAnular" CssClass="anular" ToolTip="Borrar Solicitud">
